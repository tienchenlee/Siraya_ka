...
"""
    Loki module for V1_and_VP_and_VP_and_VP_and_VP_and_VP_and_VP
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "PAST- have .AV one OBL man ka lord OBL one household ka PAST- plant -PV he .GEN NOM vineyard ka PAST- make.surround -PV he .GEN NOM fence ka PAST- dig.hole -PV he .GEN NOM hole ka lay -LV OBL PAST- press .PV ka wine OBL grape ka PAST- build .PV he .GEN NOM tower ka stone ka PAST- let.out .PV there OBL farmer ka PAST- travel .AV also go .AV LOC other OBL land":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- have .AV one OBL man ka lord OBL one household ka PAST- plant -PV he .GEN NOM vineyard ka PAST- make.surround -PV he .GEN NOM fence ka PAST- dig.hole -PV he .GEN NOM hole ka lay -LV OBL PAST- press .PV ka wine OBL grape ka PAST- build .PV he .GEN NOM tower ka stone ka PAST- let.out .PV there OBL farmer ka PAST- travel .AV also go .AV LOC other OBL land", "PAST- have .AV one OBL man ka lord OBL one household ka PAST- plant -PV he .GEN NOM vineyard ka PAST- make.surround -PV he .GEN NOM fence ka PAST- dig.hole -PV he .GEN NOM hole ka lay -LV OBL PAST- press .PV ka wine OBL grape ka PAST- build .PV he .GEN NOM tower ka stone ka PAST- let.out .PV there OBL farmer ka PAST- travel .AV also go .AV LOC other OBL land", [], {}, {})
    pprint(resultDICT)
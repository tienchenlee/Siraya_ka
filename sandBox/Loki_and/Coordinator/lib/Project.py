...
def testIntent():
    ...
    # V2
    print("[TEST] V2")
    inputLIST = ['give.birth .AV -IRR OBL child ka man ka give.name .AV -IRR you .SG .NOM OBL name his Emmanuel','give.birth .AV -IRR OBL child ka man ka give.name -LV .IRR you .SG .GEN NOM name -IRR his Jesus']

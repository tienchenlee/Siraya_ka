...
MODULE_DICT = {
    "Account": import_from_path("V_and_V_lib_Account", os.path.join(os.path.dirname(CWD_PATH), "lib/Account.py")),
    "LLM": import_from_path("V_and_V_lib_LLM", os.path.join(os.path.dirname(CWD_PATH), "lib/LLM.py"))
}
"""
Account Variables
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "cause.resemble -PV you .PL .NOM OBL graves ka whitewash -PV ka appear .AV beautiful .AV LOC surface":
        if CHATBOT:
            ...
            resultDICT["V_before"].append(args[1])
            resultDICT["V_after"].append(args[24])
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("cause.resemble -PV you .PL .NOM OBL graves ka whitewash -PV ka appear .AV beautiful .AV LOC surface", "cause.resemble -PV you .PL .NOM OBL graves ka whitewash -PV ka appear .AV beautiful .AV LOC surface", [], {}, {})
    pprint(resultDICT)
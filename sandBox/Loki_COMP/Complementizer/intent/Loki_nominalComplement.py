...
"""
    Loki module for nominalComplement
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("NOM word this LOC brothers ka not die .AV -IRR NOM disciple that", "NOM word this LOC brothers ka not die .AV -IRR NOM disciple that", [], {}, {})
    pprint(resultDICT)
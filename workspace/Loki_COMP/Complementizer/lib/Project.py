...
def testIntent():
    ...
    # V2
    print("[TEST] V2")
    inputLIST = ['see -LV GEN Herod ka PAST- deceive .AV him -OBL NOM wise observe','good .AV -IRR you .SG -OBL ka destroy -PV NOM one ka body.part your .SG','PAST- instruct -PV LOC dream ka not PC. turn .AV -IRR return .AV DET Herod -OBL','careful .AV -IRR ka not you .PL .NOM give.mercy .AV OBL merciful -PV -your .PL PC. public OBL man LOC see -PV they .GEN','PAST- hear .AV NOM DET Jesus ka PAST- deliver .PV cause.in.prison NOM DET John PAST- return .AV be.destined .AV go .AV LOC Galilee']
    pprint(testLoki(inputLIST, ['V2']))
    print("")

    # V3
    print("[TEST] V3")
    inputLIST = ['PAST- request .AV him -OBL ka PC. only .AV -IRR touch .AV OBL PART hem OBL garment his','speak -PV I .GEN you .PL .NOM ka not so .AV PAST- PC. beautiful .AV cause.dress .AV NOM DET Solomon LOC all OBL greatness OBL status his same .AV OBL one OBL it']
    pprint(testLoki(inputLIST, ['V3']))
    print("")

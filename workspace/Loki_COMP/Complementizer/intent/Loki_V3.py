...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- request .AV him -OBL ka PC. only .AV -IRR touch .AV OBL PART hem OBL garment his", "PAST- request .AV him -OBL ka PC. only .AV -IRR touch .AV OBL PART hem OBL garment his", [], {}, {})
    pprint(resultDICT)
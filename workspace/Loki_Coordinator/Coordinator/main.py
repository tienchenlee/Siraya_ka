...
MODULE_DICT = {
    "Account": import_from_path("Coordinator_lib_Account", os.path.join(CWD_PATH, "lib/Account.py")),
    "LLM": import_from_path("Coordinator_lib_LLM", os.path.join(CWD_PATH, "lib/LLM.py")),
    "Project": import_from_path("Coordinator_lib_Project", os.path.join(CWD_PATH, "lib/Project.py")),
}
"""
Account Variables

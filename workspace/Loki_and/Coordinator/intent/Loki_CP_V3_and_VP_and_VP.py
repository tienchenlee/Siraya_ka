...
"""
    Loki module for CP_V3_and_VP_and_VP
...
INTENT_NAME = "CP_V3_and_VP_and_VP"
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "know -LV GEN Jesus ka PAST- PC. all -PV NOM everything give .AV OBL father LOC hand him -OBL ka PAST- come.from -LV he .GEN OBL God ka become.back .AV -IRR also go .AV OBL God":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("know -LV GEN Jesus ka PAST- PC. all -PV NOM everything give .AV OBL father LOC hand him -OBL ka PAST- come.from -LV he .GEN OBL God ka become.back .AV -IRR also go .AV OBL God", "know -LV GEN Jesus ka PAST- PC. all -PV NOM everything give .AV OBL father LOC hand him -OBL ka PAST- come.from -LV he .GEN OBL God ka become.back .AV -IRR also go .AV OBL God", [], {}, {})
    pprint(resultDICT)
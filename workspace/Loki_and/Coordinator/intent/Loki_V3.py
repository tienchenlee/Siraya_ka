...
if __name__ == "__main__":
    ...
    resultDICT = getResult("strain -PV you .PL .GEN NOM mosquito ka swallow -PV you .PL .GEN NOM large.animal ka camel", "strain -PV you .PL .GEN NOM mosquito ka swallow -PV you .PL .GEN NOM large.animal ka camel", [], {}, {})
    pprint(resultDICT)
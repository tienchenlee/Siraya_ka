...
"""
    Loki module for V3_and_VP_and_VP
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "PAST- say .AV NOM DET Jesus him -OBL ka PAST- see -PV you .SG .GEN NOM he ka he ka talk.with.each.other .AV you .SG -OBL he NOM DET this.person":
        if CHATBOT:
    ...
    if utterance == "deliver .AV -IRR you .SG -OBL NOM adversary your .SG OBL judge ka deliver .AV -IRR also you .SG -OBL NOM judge OBL jail.officer ka put.in.jail -LV .IRR -PFV you .SG .NOM cause.in.prison":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- say .AV NOM DET Jesus him -OBL ka PAST- see -PV you .SG .GEN NOM he ka he ka talk.with.each.other .AV you .SG -OBL he NOM DET this.person", "PAST- say .AV NOM DET Jesus him -OBL ka PAST- see -PV you .SG .GEN NOM he ka he ka talk.with.each.other .AV you .SG -OBL he NOM DET this.person", [], {}, {})
    pprint(resultDICT)
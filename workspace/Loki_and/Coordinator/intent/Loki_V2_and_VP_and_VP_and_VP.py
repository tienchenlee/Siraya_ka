...
"""
    Loki module for V2_and_VP_and_VP_and_VP
...
INTENT_NAME = "V2_and_VP_and_VP_and_VP"
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "PAST- take .AV NOM DET Jesus OBL bread ka when PAST- PC. in.return .AV pray .AV PAST- break he .GEN ka PAST- give -LV he .GEN OBL disciple his NOM it ka PAST- say .AV":
        if CHATBOT:
    ...
    if utterance == "PAST- touch .AV OBL hand his ka PAST- leave .AV NOM fever her -OBL ka PAST- rise .AV ka PAST- serve .PV she .GEN him -OBL":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- touch .AV OBL hand his ka PAST- leave .AV NOM fever her -OBL ka PAST- rise .AV ka PAST- serve .PV she .GEN him -OBL", "PAST- touch .AV OBL hand his ka PAST- leave .AV NOM fever her -OBL ka PAST- rise .AV ka PAST- serve .PV she .GEN him -OBL", [], {}, {})
    pprint(resultDICT)
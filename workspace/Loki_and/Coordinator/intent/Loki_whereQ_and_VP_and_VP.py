...
"""
    Loki module for whereQ_and_VP_and_VP
...
INTENT_NAME = "whereQ_and_VP_and_VP"
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "where NOM man you .PL -OBL ka exist-one .AV OBL sheep ka when fall.in.ditch .AV or NOM it LOC day OBL sabbath ka not take .AV -IRR cause.up .AV OBL it":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("where NOM man you .PL -OBL ka exist-one .AV OBL sheep ka when fall.in.ditch .AV or NOM it LOC day OBL sabbath ka not take .AV -IRR cause.up .AV OBL it", "where NOM man you .PL -OBL ka exist-one .AV OBL sheep ka when fall.in.ditch .AV or NOM it LOC day OBL sabbath ka not take .AV -IRR cause.up .AV OBL it", [], {}, {})
    pprint(resultDICT)
...
"""
    Loki module for V3_and_VP_and_VP_and_VP
...
INTENT_NAME = "V3_and_VP_and_VP_and_VP"
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("send.forth -PV I .GEN you .PL .NOM NOM prophet NOM wise.men OBL scribe also ka kill .AV -IRR you .PL .NOM OBL some crucify also them -OBL ka punish .AV -IRR you .PL .NOM scourge .AV OBL some LOC synagogue-your .PL ka persecute .AV -IRR you .PL .NOM them -OBL LOC cities", "send.forth -PV I .GEN you .PL .NOM NOM prophet NOM wise.men OBL scribe also ka kill .AV -IRR you .PL .NOM OBL some crucify also them -OBL ka punish .AV -IRR you .PL .NOM scourge .AV OBL some LOC synagogue-your .PL ka persecute .AV -IRR you .PL .NOM them -OBL LOC cities", [], {}, {})
    pprint(resultDICT)
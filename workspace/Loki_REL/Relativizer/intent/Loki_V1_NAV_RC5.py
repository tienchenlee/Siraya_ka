...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "PAST- spread.everywhere -LV NOM hear -PV OBL name his LOC all OBL Siria ka PAST- bring .PV they .GEN him -OBL all them -OBL ka not good .AV OBL body ka different .AV OBL disease .AV OBL torment -PV ka exceed -PV OBL devil ka PC. moon .AV outburst .AV ka palsy -PV OBL body":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- spread.everywhere -LV NOM hear -PV OBL name his LOC all OBL Siria ka PAST- bring .PV they .GEN him -OBL all them -OBL ka not good .AV OBL body ka different .AV OBL disease .AV OBL torment -PV ka exceed -PV OBL devil ka PC. moon .AV outburst .AV ka palsy -PV OBL body", "PAST- spread.everywhere -LV NOM hear -PV OBL name his LOC all OBL Siria ka PAST- bring .PV they .GEN him -OBL all them -OBL ka not good .AV OBL body ka different .AV OBL disease .AV OBL torment -PV ka exceed -PV OBL devil ka PC. moon .AV outburst .AV ka palsy -PV OBL body", [], {}, {})
    pprint(resultDICT)
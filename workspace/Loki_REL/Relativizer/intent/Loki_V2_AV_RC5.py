...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "come.upon .AV -IRR you .PL -OBL NOM all OBL PART blood ka righteous .AV ka PAST- pour -PV LOC earth PART blood GEN Abel ka PART righteous .AV LOC time until OBL PART blood GEN Zacharias ka DET son GEN Barachias ka PAST- murder -PV -you .PL .GEN LOC middle OBL temple OBL worship -PV OBL God OBL place OBL sacrifice -LV":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("come.upon .AV -IRR you .PL -OBL NOM all OBL PART blood ka righteous .AV ka PAST- pour -PV LOC earth PART blood GEN Abel ka PART righteous .AV LOC time until OBL PART blood GEN Zacharias ka DET son GEN Barachias ka PAST- murder -PV -you .PL .GEN LOC middle OBL temple OBL worship -PV OBL God OBL place OBL sacrifice -LV", "come.upon .AV -IRR you .PL -OBL NOM all OBL PART blood ka righteous .AV ka PAST- pour -PV LOC earth PART blood GEN Abel ka PART righteous .AV LOC time until OBL PART blood GEN Zacharias ka DET son GEN Barachias ka PAST- murder -PV -you .PL .GEN LOC middle OBL temple OBL worship -PV OBL God OBL place OBL sacrifice -LV", [], {}, {})
    pprint(resultDICT)
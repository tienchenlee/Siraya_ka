...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "he NOM PC. return .AV -IRR take .AV OBL one hundred ka inherit .AV -IRR also OBL life ka always .AV be.lasting .AV":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("he NOM PC. return .AV -IRR take .AV OBL one hundred ka inherit .AV -IRR also OBL life ka always .AV be.lasting .AV", "he NOM PC. return .AV -IRR take .AV OBL one hundred ka inherit .AV -IRR also OBL life ka always .AV be.lasting .AV", [], {}, {})
    pprint(resultDICT)
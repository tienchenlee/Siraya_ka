...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "PAST- give.birth .PV NOM DET Jesus LOC Bethlehem ka at Judaea LOC day OBL ruler ka chief ka DET Herod see -LV .IRR PAST- travel .AV NOM wise observe ka PAST- from.east .AV come .AV LOC Jerusalem":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- give.birth .PV NOM DET Jesus LOC Bethlehem ka at Judaea LOC day OBL ruler ka chief ka DET Herod see -LV .IRR PAST- travel .AV NOM wise observe ka PAST- from.east .AV come .AV LOC Jerusalem", "PAST- give.birth .PV NOM DET Jesus LOC Bethlehem ka at Judaea LOC day OBL ruler ka chief ka DET Herod see -LV .IRR PAST- travel .AV NOM wise observe ka PAST- from.east .AV come .AV LOC Jerusalem", [], {}, {})
    pprint(resultDICT)
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "yet who NOM drink .AV -IRR -PFV OBL water ka give -IV .IRR I .GEN him -OBL not thirsty .AV -IRR LOC always -LV be.lasting .AV then water ka give -IV .IRR I .GEN him -OBL become.fountain .AV -IRR -PFV him -OBL OBL water ka spring.up LOC life ka always .AV be.lasting .AV":
        if CHATBOT:

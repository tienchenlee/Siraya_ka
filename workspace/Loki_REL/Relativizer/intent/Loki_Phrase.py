...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "woe OBL man ka cause.come .AV OBL offend -PV cause.sin":
        if CHATBOT:
    ...
    if utterance == "woe you .PL ka scribe OBL Pharisee also ka different -PV OBL heart OBL word give you .PL .NOM OBL part ka one ten OBL mint OBL dill OBL cumin also":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
    ...
    if utterance == "woe you .PL ka scribe OBL Pharisees also ka different -PV OBL heart OBL word":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("woe OBL man ka cause.come .AV OBL offend -PV cause.sin", "woe OBL man ka cause.come .AV OBL offend -PV cause.sin", [], {}, {})
    pprint(resultDICT)
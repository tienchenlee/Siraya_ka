...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "he ka PAST- sow .PV LOC earth ka good .AV he NOM DET this.person ka while hear .AV OBL word ka understand .AV OBL it ka bear.fruit .AV":
        if CHATBOT:
    ...
    if utterance == "one OBL man ka have-son .AV OBL two ka when come -LV he .GEN OBL first":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("ought ka fulfill -PV .IRR NOM this ka NEG not.willing -LV .IRR NOM that", "ought ka fulfill -PV .IRR NOM this ka NEG not.willing -LV .IRR NOM that", [], {}, {})
    pprint(resultDICT)
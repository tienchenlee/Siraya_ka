...
"""
    Loki module for Nominal_Predicate_RC6
...
INTENT_NAME = "Nominal_Predicate_RC6"
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "he NOM DET John ka PAST- have .AV OBL clothing his ka PART hair OBL large.animal ka have.back .AV ka camel call .AV OBL girdle also ka PART leather ka PAST- gird .AV OBL loins his":
        if CHATBOT:
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("he NOM DET John ka PAST- have .AV OBL clothing his ka PART hair OBL large.animal ka have.back .AV ka camel call .AV OBL girdle also ka PART leather ka PAST- gird .AV OBL loins his", "he NOM DET John ka PAST- have .AV OBL clothing his ka PART hair OBL large.animal ka have.back .AV ka camel call .AV OBL girdle also ka PART leather ka PAST- gird .AV OBL loins his", [], {}, {})
    pprint(resultDICT)
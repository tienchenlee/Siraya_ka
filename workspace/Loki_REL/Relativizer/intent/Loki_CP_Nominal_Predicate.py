...
"""
    Loki module for CP_Nominal_Predicate
...
INTENT_NAME = "CP_Nominal_Predicate"
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "not you .PL .GEN or PAST- read .PV ka he ka PAST- make .AV OBL man LOC beginning ka PAST- make .PV he .GEN them -OBL NOM man NOM woman":
        if CHATBOT:
    ...
    if utterance == "know -PV we .EXCL ka teacher you .SG .NOM ka PAST- come.from .AV OBL God":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("not you .PL .GEN or PAST- read .PV ka he ka PAST- make .AV OBL man LOC beginning ka PAST- make .PV he .GEN them -OBL NOM man NOM woman", "not you .PL .GEN or PAST- read .PV ka he ka PAST- make .AV OBL man LOC beginning ka PAST- make .PV he .GEN them -OBL NOM man NOM woman", [], {}, {})
    pprint(resultDICT)
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "PAST- enter .AV NOM ruler ka chief LOC see -LV .IRR he .GEN NOM guest PAST- see -LV he .GEN NOM people ka not wear .AV LOC celebration OBL marriage":
        if CHATBOT:
    ...
    if utterance == "come .AV NOM he ka PAST- PC. two OBL talent PAST- say .PV he .GEN lord two OBL talent NOM PAST- give -PV you .SG .GEN me -OBL see -LV .IRR two still OBL other OBL talent ka PAST- PC. more .PV I .NOM make.profit .AV":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
    ...
    if utterance == "let.grow .AV LOC harvest -LV .IRR ka LOC time OBL harvest -PV speak -LV .IRR I .GEN OBL man ka harvest .AV -IRR First .AV -IRR collect OBL herb ka not good .AV":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- enter .AV NOM ruler ka chief LOC see -LV .IRR he .GEN NOM guest PAST- see -LV he .GEN NOM people ka not wear .AV LOC celebration OBL marriage", "PAST- enter .AV NOM ruler ka chief LOC see -LV .IRR he .GEN NOM guest PAST- see -LV he .GEN NOM people ka not wear .AV LOC celebration OBL marriage", [], {}, {})
    pprint(resultDICT)
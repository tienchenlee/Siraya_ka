...
if __name__ == "__main__":
    ...
    resultDICT = getResult("PAST- give .AV NOM DET Moses you .PL -OBL OBL bread ka from-heaven .AV", "PAST- give .AV NOM DET Moses you .PL -OBL OBL bread ka from-heaven .AV", [], {}, {})
    pprint(resultDICT)
...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "hear .AV OBL ruler ka chief PAST- leave .AV -PFV FOC ka see -LV .IRR NOM star ka PAST- see .PV they .GEN at.east .AV PAST- PC. front .AV go.along .AV them -OBL LOC extent until ka it ka PAST- go.along .AV":
        if CHATBOT:
    ...
    if utterance == "speak.good .AV -IRR them -OBL ka curse .AV you .PL -OBL FOC good -LV .IRR them -OBL ka hate .AV you .PL -OBL Pray .AV -IRR because they -OBL ka damage .AV ka persecute .AV you .PL -OBL FOC":
        if CHATBOT:
            replySTR = getReply(utterance, args)
            if replySTR:
                resultDICT["response"] = replySTR
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("speak.good .AV -IRR them -OBL ka curse .AV you .PL -OBL FOC good -LV .IRR them -OBL ka hate .AV you .PL -OBL Pray .AV -IRR because they -OBL ka damage .AV ka persecute .AV you .PL -OBL FOC", "speak.good .AV -IRR them -OBL ka curse .AV you .PL -OBL FOC good -LV .IRR them -OBL ka hate .AV you .PL -OBL Pray .AV -IRR because they -OBL ka damage .AV ka persecute .AV you .PL -OBL FOC", [], {}, {})
    pprint(resultDICT)
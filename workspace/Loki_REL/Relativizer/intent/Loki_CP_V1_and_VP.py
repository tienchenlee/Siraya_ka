...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "same .AV ka so .AV OBL time while not.have yet NOM flood ka great .AV ka PAST- eat .AV PAST- drink PAST- marry .AV PAST- cause.marry .AV NOM they LOC time until OBL day that ka PAST- enter .PV DET Noah LOC vessel ka PAST- build.ship .PV":
        if CHATBOT:
